...
export function HeroComponentV4(
    {
    ...
    return (
        <_Component
            ...
            tag="section"><_Builtin.Block className="page-padding" tag="div"><_Builtin.Block className="container-1224" tag="div"><_Builtin.Block className="padding-section-t128-518b" tag="div"><_Builtin.Block className="hero-component_wrapper" tag="div"><_Builtin.Block className="hero-component_txt-wrapper is-center" tag="div"><_Builtin.Block className="hero-component_txtinfo-wrap" tag="div"><_Builtin.Heading className="heading-56 text-color-white" tag="h1">{"Discover the key to grow your business"}</_Builtin.Heading><_Builtin.Heading className="text-size-16 text-color-white" tag="h2">{"Lorem ipsum dolor sit amet consectetur adipiscing elidolor mattis sit phasellus mollis sit aliquam sit nullam neques."}</_Builtin.Heading></_Builtin.Block><_Builtin.Block className="hero-component_cta-layout" tag="div"><_Builtin.Block className="hero-component_cta-wrap" tag="div"><ButtonPrimary buttonLabel="Get in Touch" /></_Builtin.Block><_Builtin.Block className="hero-component_cta-wrap" tag="div"><ButtonPrimary buttonLabel="Learn More" variant="Secondary" /></_Builtin.Block></_Builtin.Block></_Builtin.Block><_Builtin.Block className="hero-component_img-container _02" tag="div"><_Builtin.Block className="hero-component_img-wrapper ratio-16-9" tag="div"><_Builtin.Image
