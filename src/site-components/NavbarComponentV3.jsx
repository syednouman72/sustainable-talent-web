...
export function NavbarComponentV3(
    {
                    ...
                    noScroll: false
                                    ...
                                    options={{
                                        ...
                                        src="https://cdn.prod.website-files.com/692d9bd20e09dba5c24a10a4/692d9bd50e09dba5c24a118b_Logo.svg" /></_Builtin.NavbarBrand><_Builtin.NavbarMenu className="navbar-component_menu is-auto" tag="nav" role="navigation"><_Builtin.Block className="navbar-component_menu-item-wrapper" tag="div"><_Builtin.List className="navmenu-list_wrapper" tag="ul" unstyled={true}><_Builtin.ListItem className="navmenu-list_item-wrapper"><_Builtin.Link
                                                    ...
                                                    options={{
                                                        href: "#"
                                                    }}>{"Pricing"}</_Builtin.Link></_Builtin.ListItem><_Builtin.ListItem className="navmenu-list_item-wrapper"><ButtonPrimary buttonLabel="Get Started" /></_Builtin.ListItem></_Builtin.List></_Builtin.Block></_Builtin.NavbarMenu><_Builtin.NavbarButton className="menu-button" tag="div"><_Builtin.Icon
                                        widget={{
                                            type: "icon",
                                            icon: "nav-menu"
